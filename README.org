...
The app is currently unsigned and unnotarized. If macOS says the developer
cannot be verified or Apple cannot check it, and you trust the download
from this repository:

1. Try opening the installed app once and dismiss the alert.
