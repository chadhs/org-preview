...
The smoke test checks rendering, source view, themes, document search, file
opening, saves, atomic replacement, delete/recreate recovery, and sandboxed
rendering. Screenshots are saved in =test-results/=.
